...
def create_submission_file(predicted_logits_files, train_file_path, dev_file_path, test_file_path,
                           article_ids, span_starts, span_ends, output_file, weights=None, data_dir=None,
                           agg_model=None):
    ...
    if agg_model is not None:
        ...
        predictions_sklearn_agg[predictions_sklearn_agg == 'Repetition'] = predictions[
            predictions_sklearn_agg == 'Repetition']
